<template>
  <section
    id="about"
    class="relative flex min-h-[50vh] items-center justify-center overflow-hidden bg-[url(/top-view-school-supplies-dark-surface.jpg)] bg-cover bg-center bg-no-repeat lg:bg-fixed"
  >
