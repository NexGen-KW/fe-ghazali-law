...
defineProps<{
  member?: { participations?: string; participations_ar?: string };
}>();
</script>
...
<template>
  <section
    v-if="
      (locale === 'ar' ? member?.participations_ar : member?.participations) ||
